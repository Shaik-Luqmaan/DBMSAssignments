...
-- List the plan number, event number, work date, and activity of event plans
-- meeting the following two conditions: (1) the work date is in December 2018 and 
...
-- List the plan number, line number, resource name, number of resources (eventplanline.number), location name, time start, and time end where the event is held at the basketball arena, 
...
select EventPlanLine.PlanNo, ResName, NumberFld, LocName, TimeStart, TimeEnd
...
+--------+-----------+-----------+-------------+---------------------+---------------------+
| PlanNo | ResName   | NumberFld | LocName     | TimeStart           | TimeEnd             |
+--------+-----------+-----------+-------------+---------------------+---------------------+
| P101   | attendant |         2 | Locker room | 2018-12-03 18:00:00 | 2018-12-03 20:00:00 |
| P101   | attendant |         4 | Gate        | 2018-12-03 18:30:00 | 2018-12-03 19:00:00 |
| P101   | nurse     |         2 | Locker room | 2018-12-03 19:00:00 | 2018-12-03 20:00:00 |
| P102   | attendant |         2 | Locker room | 2018-12-05 18:00:00 | 2018-12-05 19:00:00 |
| P102   | attendant |         4 | Gate        | 2018-12-05 18:00:00 | 2018-12-05 21:00:00 |
| P102   | nurse     |         2 | Locker room | 2018-12-05 19:00:00 | 2018-12-05 22:00:00 |
| P103   | attendant |         2 | Locker room | 2018-12-12 18:00:00 | 2018-12-12 21:00:00 |
| P103   | attendant |         4 | Gate        | 2018-12-12 18:00:00 | 2018-12-12 21:00:00 |
| P103   | nurse     |         2 | Locker room | 2018-12-12 19:00:00 | 2018-12-12 22:00:00 |
+--------+-----------+-----------+-------------+---------------------+---------------------+
...
-- 
-- mysql> insert into Facility values ("F104", "Swimming Pool");
...
-- mysql> insert into Location values ("L107", "F104", "Door");
-- Query OK, 1 row affected (0.00 sec)
...
-- mysql> insert into Location values ("L108", "F104", "Locker Room");
-- Query OK, 1 row affected (0.00 sec)
-- 
